...
class SituationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create situation" do
    assert_difference('Situation.count') do
      post situations_url, params: { situation: { title: @situation.title, user_id: @situation.user_id } }
    end
  ...
  test "should update situation" do
    patch situation_url(@situation), params: { situation: { title: @situation.title, user_id: @situation.user_id } }
